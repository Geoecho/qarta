            ...
            <AnimatePresence initial={false}>
                {isOpen && (
                    ...
                    >
                        ...
                        {section.filters && (
                            <div style={{
                                padding: '16px 20px 4px 20px', // Header(16) -> Filter(4) -> Item(12) = 16px gap
                                display: 'flex',
                                gap: '8px',
                                overflowX: 'auto',
                        ...
                        <div style={{ padding: section.filters && section.filters.length > 0 ? '0 20px 16px 20px' : '4px 20px 16px 20px' }}>
